...
class Server:
    def __init__(self):
        ...
        application.add_routes(
            [web.post("/api/v1/metro/verificate/", self.post_handler)]
        )
    ...
    async def post_handler(self, request):
        ...
        set_input_stations = {
            metro_station for metro_station in input_data["stations list"]
        }
        ...
        result = json.dumps(
            {"unchanged": unchanged, "update": updated, "deleted": deleted},
            ensure_ascii=False,
        )
